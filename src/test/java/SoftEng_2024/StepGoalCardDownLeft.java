...
public class StepGoalCardDownLeft {
    public static void main(String[] args) throws Board.notAvailableCellException, Board.necessaryResourcesNotAvailableException {
        ...
        Angles[] resources7 = {Angles.EMPTY, Angles.EMPTY, Angles.EMPTY, Angles.EMPTY, Angles.FUNGI};
        Angles[] resources8 = {Angles.EMPTY, Angles.EMPTY, Angles.EMPTY, Angles.EMPTY, Angles.FUNGI};
        ...
        //GOAL CARD
        //GoalCard stepUpLeft = (StepGoalCard) new StepGoalCard(Angles.INSECTS,Angles.FUNGI,false,true,1 );
        ...
        board.updateBoard(48,44,resourceCard9);
        ...
        */
        ...
        board.updateBoard(51,43,resourceCard8);
        System.out.println(stepUpLeft.calcScore(board));
        */
    }
}