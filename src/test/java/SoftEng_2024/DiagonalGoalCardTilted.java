...
import SoftEng_2024.Model.DiagonalGoalCard;
...
public class DiagonalGoalCardTilted {
    public static void main(String[] args) throws Board.notAvailableCellException, Board.necessaryResourcesNotAvailableException {
        ...
        //GOAL CARD
        //GoalCard tiltedCard = (DiagonalGoalCard) new DiagonalGoalCard(Angles.INSECTS,1,false);
        ...
        /*
        board.updateBoard(41,41,resourceCard1);
        board.updateBoard(40,40,resourceCard2);
        board.updateBoard(39,39,resourceCard3);
        board.updateBoard(38,38,resourceCard4);
        board.updateBoard(43,43,resourceCard5);
        board.updateBoard(44,44,resourceCard6);
        board.updateBoard(45,45,resourceCard7);
        System.out.println(tiltedCard.calcScore(board)); */

        //DIAGONAL WITHOUT ANY DIFFERENT CARD IN THE MIDDLE EXPECTED SCORE: 2 (UPLEFT)
        /*
        board.updateBoard(41,41,resourceCard1);
        board.updateBoard(40,40,resourceCard2);
        board.updateBoard(39,39,resourceCard3);
        board.updateBoard(38,38,resourceCard4);
        board.updateBoard(37,37,resourceCard5);
        board.updateBoard(36,36,resourceCard6);
        board.updateBoard(35,35,resourceCard7);
        System.out.println(tiltedCard.calcScore(board));
         */

        //DIAGONAL WITHOUT ANY DIFFERENT CARD IN THE MIDDLE EXPECTED SCORE: 2 (DOWNRIGHT)
        /*
        board.updateBoard(43,43,resourceCard1);
        board.updateBoard(44,44,resourceCard2);
        board.updateBoard(45,45,resourceCard3);
        board.updateBoard(46,46,resourceCard4);
        board.updateBoard(47,47,resourceCard5);
        board.updateBoard(48,48,resourceCard6);
        board.updateBoard(49,49,resourceCard7);
        System.out.println(tiltedCard.calcScore(board));
        */

        //SINGLE TILTED EXPECTED SCORE: 1 (UPLEFT)
        /*
        board.updateBoard(41,41,resourceCard1);
        board.updateBoard(40,40,resourceCard2);
        board.updateBoard(39,39resourceCard3);
        System.out.println(tiltedCard.calcScore(board));
        */

        //SINGLE TILTED EXPECTED SCORE: 1 (DOWNRIGHT)
        /*
        board.updateBoard(43,43,resourceCard1);
        board.updateBoard(44,44,resourceCard2);
        board.updateBoard(45,45,resourceCard3);
