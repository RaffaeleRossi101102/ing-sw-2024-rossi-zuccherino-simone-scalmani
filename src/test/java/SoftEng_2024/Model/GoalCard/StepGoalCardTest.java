...
class StepGoalCardTest {
    ...
    private StepGoalCard testGoal;
    private StepGoalCard testGoal2;
    ...
    void setUp() throws Exception {
        ...
        testGoal = new StepGoalCard(Angles.INSECTS, Angles.PLANTS, false, false, 3, String.format("Get %s points for each regular L-shaped (L) pattern with an %s card at the base and a %s card on the side", 3, Angles.INSECTS, Angles.PLANTS), 0);
        testGoal2 = new StepGoalCard(Angles.FUNGI, Angles.ANIMALS, true, true, 3, String.format("Get %s points for each regular L-shaped (L) pattern with an %s card at the base and a %s card on the side", 3, Angles.FUNGI, Angles.ANIMALS), 0);
    }
    ...
    void calcScore() throws Board.necessaryResourcesNotAvailableException, Board.notAvailableCellException {
        ...
        ResourceCard testCard = new ResourceCard(testFront, true, new Angles[]{Angles.EMPTY, Angles.EMPTY, Angles.EMPTY, Angles.EMPTY, Angles.PLANTS}, 0);
        ...
        gameController.getGame().getPlayers().get(0).getPlayerBoard().updateBoard(41, 43, gameController.getGame().getPlayers().get(0).getHand().get(1));
        gameController.getGame().getPlayers().get(0).getPlayerBoard().updateBoard(43, 43, gameController.getGame().getPlayers().get(0).getHand().get(2));
        gameController.getGame().getPlayers().get(0).getPlayerBoard().updateBoard(44, 42, gameController.getGame().getPlayers().get(0).getHand().get(3));
        gameController.getGame().getPlayers().get(0).getPlayerBoard().updateBoard(42, 44, gameController.getGame().getPlayers().get(0).getHand().get(4));
        ...
        gameController.getGame().getPlayers().get(0).getPlayerBoard().updateBoard(45, 43, gameController.getGame().getPlayers().get(0).getHand().get(6));
        gameController.getGame().getPlayers().get(0).getPlayerBoard().updateBoard(41, 45, gameController.getGame().getPlayers().get(0).getHand().get(7));
        gameController.getGame().getPlayers().get(0).getPlayerBoard().updateBoard(43, 45, gameController.getGame().getPlayers().get(0).getHand().get(8));
        gameController.getGame().getPlayers().get(0).getPlayerBoard().updateBoard(46, 44, gameController.getGame().getPlayers().get(0).getHand().get(9));


        int score, score2;
        score = testGoal.calcScore(gameController.getGame().getPlayers().get(0).getPlayerBoard());
        score2 = testGoal2.calcScore(gameController.getGame().getPlayers().get(0).getPlayerBoard());
